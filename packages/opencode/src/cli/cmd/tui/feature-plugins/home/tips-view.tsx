...
const TIPS: Tip[] = [
  ...
  "Ejecutá {highlight}/share{/highlight} para crear un enlace público a tu conversación en haz.ai",
  ...
  "Creá {highlight}haz.json{/highlight} para configuración del servidor y {highlight}tui.json{/highlight} para configuración TUI",
  "Poné la configuración TUI en {highlight}~/.config/haz/tui.json{/highlight} para config global",
  ...
  "Creá un plugin para evitar que haz lea archivos sensibles",
  "Usá {highlight}haz run{/highlight} para scripting no interactivo",
  "Usá {highlight}haz --continue{/highlight} para reanudar la última sesión",
  "Usá {highlight}haz run -f archivo.ts{/highlight} para adjuntar archivos via CLI",
  "Usá {highlight}--format json{/highlight} para salida legible por máquina en scripts",
  "Ejecutá {highlight}haz serve{/highlight} para acceso API sin interfaz a haz",
  "Usá {highlight}haz run --attach{/highlight} para conectar a un servidor en ejecución",
  "Ejecutá {highlight}haz upgrade{/highlight} para actualizar a la última versión",
  "Ejecutá {highlight}haz auth list{/highlight} para ver todos los proveedores configurados",
  "Ejecutá {highlight}haz agent create{/highlight} para creación guiada de agentes",
  "Usá {highlight}/haz{/highlight} en issues/PRs de GitHub para activar acciones de IA",
  "Ejecutá {highlight}haz github install{/highlight} para configurar el workflow de GitHub",
  "Comentá {highlight}/haz fix this{/highlight} en issues para auto-crear PRs",
  ...
  "Ejecutá {highlight}haz debug config{/highlight} para diagnosticar la configuración",
  ...
  "Usá {highlight}/connect{/highlight} con haz Zen para modelos seleccionados y probados",
