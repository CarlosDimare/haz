      ...
      >
        <box flexDirection="row" justifyContent="space-between" gap={1}>
          ...
          <box flexDirection="row" gap={2}>
            ...
            >
              <text fg={theme.text}>
                Padre <span style={{ fg: theme.textMuted }}>{parentShortcut()}</span>
              </text>
            </box>
            <box
            ...
            >
              <text fg={theme.text}>
                Ant <span style={{ fg: theme.textMuted }}>{previousShortcut()}</span>
              </text>
            </box>
            <box
            ...
            >
              <text fg={theme.text}>
                Sig <span style={{ fg: theme.textMuted }}>{nextShortcut()}</span>
              </text>
            </box>
          </box>
        </box>
