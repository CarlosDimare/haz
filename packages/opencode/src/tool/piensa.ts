      ...
      execute: (_params: {}, ctx: Tool.Context) =>
        Effect.gen(function* () {
          ...
          const answers = yield* question.ask({
            ...
            questions: [
              {
                question: `Plan at ${plan} is complete. Would you like to switch to haz agent and start implementing?`,
                header: "Haz Agent",
                custom: false,
                options: [
          ...
          return {
            title: "Switching to haz agent",
            output: "User approved switching to haz agent. Wait for further instructions.",
            metadata: {},
          }
        }).pipe(Effect.orDie),
    }
